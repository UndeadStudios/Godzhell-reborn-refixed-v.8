        ...
        switch (objectId) {
            ...
            case 1569:
                if (player.objectY > 9830 && player.objectY < 9833 && player.absY != 9830) {
                    ...
                    handleSpecialGate(player, 1569, 1568, 3146, 9871, 3146, 9870, 3145, 9871, 3145, 9870, 0);
                }
                break;
            case 1568:
                if (player.objectY > 9830 && player.objectY < 9833 && player.absY != 9830) {
                    ...
                    handleSpecialGate(player, 1568, 1569, 3146, 9870, 3146, 9871, 3145, 9870, 3145, 9871, 0);
                }
                break;
            case 3506:
